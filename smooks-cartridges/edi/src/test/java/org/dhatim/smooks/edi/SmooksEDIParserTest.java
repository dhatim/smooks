...
import org.dhatim.delivery.dom.DOMParser;
...
public class SmooksEDIParserTest {
	...
	private static final String TEST_XML_MAPPING_XML_URI = "classpath:/org/dhatim/smooks/edi/edi-to-xml-mapping.xml";
	...
	public void test_invalid_config() throws IOException, SAXException {
		...
		try {
			...
			assertEquals("Invalid EDI mapping model config specified for org.dhatim.edisax.EDIParser.  Unable to access URI based mapping model [http://nothing/there.xml].", e.getCause().getMessage());
		}
