...
public class GroovyContentHandlerFactoryTest {
	...
	public void test_goodscript_by_URI() throws InstantiationException, IllegalArgumentException, IOException, SAXException {
		test_goodscript_by_URI("classpath:/org/dhatim/smooks/scripting/groovy/MyGroovyScript.groovy");
		test_goodscript_by_URI("/org/dhatim/smooks/scripting/groovy/MyGroovyScript.groovy");
	}
