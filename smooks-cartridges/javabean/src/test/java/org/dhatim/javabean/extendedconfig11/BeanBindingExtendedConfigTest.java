...
*/
package org.dhatim.javabean.extendedconfig11;
...
import org.dhatim.javabean.B;
import org.dhatim.javabean.Header;
import org.dhatim.javabean.OrderItem;
import org.dhatim.javabean.extendedconfig.ExtendedOrder;
...
public class BeanBindingExtendedConfigTest {
	...
	private InputStream getInput(String file) {
		return ClassUtil.getResourceAsStream("/org/dhatim/javabean/extendedconfig/" + file, this.getClass());
	}
    ...
    public void test_error_for_no_property_on_non_list_or_array() throws IOException, SAXException {
        try {
            ...
            assertEquals("'wiring' binding for bean class 'org.dhatim.javabean.extendedconfig.ExtendedOrder' must specify a 'property' or 'setterMethod' attribute.", e.getCause().getMessage());
        }
    }
