...
public class BasicFactoryDefinitionParserTest {
	...
	public void test_create_StaticMethodFactory() {
		...
		Factory<?> factory = parser.parse("org.dhatim.javabean.TestFactory#newArrayList");
	...
	public void test_create_FactoryInstanceFactory() {
		...
		Factory<?> factory = parser.parse("org.dhatim.javabean.TestFactory#newInstance.newLinkedList");
	...
	public void test_caching() {
		...
		Factory<?> factory1 = parser.parse("org.dhatim.javabean.TestFactory#newArrayList");
		Factory<?> factory2 = parser.parse("org.dhatim.javabean.TestFactory#newArrayList");
		Factory<?> factory3 = parser.parse("org.dhatim.javabean.TestFactory#newInstance.newLinkedList");
	...
	public void test_null_factory() {
		...
		Factory<?> factory = parser.parse("org.dhatim.javabean.TestFactory#getNull.newLinkedList");
	...
	public void test_invalid_class() {
		...
		try {
			parser.parse("org.dhatim.javabean.DoesNotExist#newArrayList");
	...
	public void test_invalid_method() {
		...
		try {
			parser.parse("org.dhatim.javabean.TestFactory#doesNotExist");
		} catch (FactoryException e) {
			exception = e;
		}
	...
	public void test_not_static_method() {
		...
		try {
			parser.parse("org.dhatim.javabean.TestFactory#newLinkedList");
		} catch (FactoryException e) {
			exception = e;
		}
