...
public class Bean extends BindingAppender {
     ...
     * <p/>
     * Discovers the {@link org.dhatim.javabean.DataDecoder} through the specified
     * bindingMember.
     *
     ...
     *                      or method name.
     * @param dataSelector  The data selector for the data value to be bound.
     * @param dataDecoder   The {@link org.dhatim.javabean.DataDecoder} to be used for decoding
     *                      the data value.
     * @return <code>this</code> Bean configuration instance.
     */
