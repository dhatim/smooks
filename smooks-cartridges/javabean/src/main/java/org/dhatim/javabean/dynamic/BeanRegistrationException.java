...
public class BeanRegistrationException extends SmooksException {
     ...
     * a model doesn't have registered {@link org.dhatim.javabean.dynamic.BeanMetadata}
     ...
     * {@link org.dhatim.javabean.dynamic.serialize.DefaultNamespace} annotation.
     * <p/>
     * All namespace root bean types must be annotated with the {@link org.dhatim.javabean.dynamic.serialize.DefaultNamespace}
     * annotation.
     *
     * @param bean The bean instance.
     * @throws BeanRegistrationException The exception.
