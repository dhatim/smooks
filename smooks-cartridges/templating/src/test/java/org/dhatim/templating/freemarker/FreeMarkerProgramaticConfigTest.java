...
public class FreeMarkerProgramaticConfigTest {
    ...
    public void testFreeMarkerTrans_01() throws SAXException, IOException {
        ...
        smooks.addVisitor(new FreeMarkerTemplateProcessor(new TemplatingConfiguration("/org/dhatim/templating/freemarker/test-template.ftl")),"c");
    ...
    public void testInsertBefore() throws SAXException, IOException {
        ...
        smooks.addVisitor(
                new FreeMarkerTemplateProcessor(
                        new TemplatingConfiguration("/org/dhatim/templating/freemarker/test-template.ftl").setUsage(Inline.INSERT_BEFORE)
                ),
                "c"
        );
    ...
    public void testInsertAfter() throws SAXException, IOException {
        ...
        smooks.addVisitor(
                new FreeMarkerTemplateProcessor(
                        new TemplatingConfiguration("/org/dhatim/templating/freemarker/test-template.ftl").setUsage(Inline.INSERT_AFTER)
                ),
                "c"
        );
    ...
    public void testAddTo() throws SAXException, IOException {
        ...
        smooks.addVisitor(
                new FreeMarkerTemplateProcessor(
                        new TemplatingConfiguration("/org/dhatim/templating/freemarker/test-template.ftl").setUsage(Inline.ADDTO)
                ),
                "c"
        );
