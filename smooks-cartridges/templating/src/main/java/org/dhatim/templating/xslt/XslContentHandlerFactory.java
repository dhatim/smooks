...
/**
 * XSL {@link org.dhatim.delivery.dom.DOMElementVisitor} Creator class.
 * <p/>
 * Creates {@link org.dhatim.delivery.dom.DOMElementVisitor} instances for performing node/element level
 ...
 * the system property "org.dhatim.templating.xslt.synchronized".  According to the spec,
 ...
 *     &lt;resource&gt;<b>XSL Resource - Inline or {@link org.dhatim.resource.URIResourceLocator URI}</b>&lt;/resource&gt;
 *
 ...
 * <a href="http://xml.apache.org/xalan-j/">Xalan</a> extension {@link org.dhatim.templating.xslt.XalanJavabeanExtension}.
 *
...
public class XslContentHandlerFactory implements ContentHandlerFactory {
     ...
     */
    public static final String ORG_MILYN_TEMPLATING_XSLT_SYNCHRONIZED = "org.dhatim.templating.xslt.synchronized";
     ...
     *
     * @param resourceConfig The SmooksResourceConfiguration for the XSL {@link org.dhatim.delivery.ContentHandler}
     *                       to be created.
     * @return XSL {@link org.dhatim.delivery.ContentHandler} instance.
     * @see org.dhatim.delivery.JavaContentHandlerFactory
     */
