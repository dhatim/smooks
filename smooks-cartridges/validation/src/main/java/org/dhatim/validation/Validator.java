...
import org.dhatim.rules.RuleProviderAccessor;
 ...
 * <pre>{@code
 * <rules:ruleBases>
 *    <rules:ruleBase name="addressing" src="usa_address.properties" provider="org.dhatim.smooks.validation.RegexProvider" />
 * </rules:ruleBases>
 *
...
public final class Validator implements SAXVisitBefore, SAXVisitAfter, DOMVisitAfter
{
     ...
     * @param executionContext The Smooks {@link org.dhatim.container.ExecutionContext}.
     *
