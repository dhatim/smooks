...
import org.dhatim.classpath.*;
import org.dhatim.container.*;
import org.dhatim.delivery.Filter;
import org.dhatim.delivery.Visitor;
import org.dhatim.delivery.sax.*;
import org.dhatim.expression.*;
import org.dhatim.io.*;
import org.dhatim.profile.*;
import org.dhatim.resource.*;
import org.dhatim.util.*;
 ...
 * simply a configuration parameter (see {@link org.dhatim.cdr.ParameterAccessor}).
 * <p/>
 ...
 *          &lt;resource&gt;{@link org.dhatim.delivery.dom.DOMElementVisitor com.acme.transform.MyJavaOrderItemTransformer}&lt;/resource&gt;
 *      &lt;/resource-config&gt;</b>
 ...
 * whereas resource 2 is only targeted at "message-exchange-1" and resource 3 at "message-exchange-2" (see {@link org.dhatim.Smooks#createExecutionContext(String)}).
 * <pre>
 * <i>&lt;?xml version='1.0'?&gt;
 * &lt;smooks-resource-list xmlns="http://www.milyn.org/xsd/smooks-1.0.xsd"&gt;
 *      <b>&lt;profiles&gt;
 ...
 * <li>Targeting a specific {@link org.dhatim.xml.SmooksXMLReader} at a specific profile.</li>
 * </ol>
 * <p/>
 * </li>
...
public class SmooksResourceConfiguration {
     ...
     * e.g. {@link org.dhatim.delivery.dom.serialize.DefaultSerializationUnit} or
     * {@link org.dhatim.delivery.sax.DefaultSAXElementSerializer}.
     */
     ...
     *
     * @param expressionEvaluator The {@link org.dhatim.expression.ExpressionEvaluator}, or null if no condition is to be used.
     */
     ...
     *
     * @return The {@link org.dhatim.expression.ExpressionEvaluator}, or null if no condition is specified.
     */
     ...
     * <p/>
     * Some resources (e.g. {@link org.dhatim.delivery.dom.serialize.DefaultSerializationUnit} or
     * {@link org.dhatim.delivery.sax.DefaultSAXElementSerializer}) are applied by default when no other
    ...
    /**
     * Create a {@link Properties} instance from this supplied {@link org.dhatim.cdr.SmooksResourceConfiguration}
