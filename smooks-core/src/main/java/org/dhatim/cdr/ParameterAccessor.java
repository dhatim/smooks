 ...
 * (see {@link org.dhatim.cdr.SmooksResourceConfiguration}).  The parameter values are
 * stored in the &lt;param&gt; elements within this Content Delivery Resource definition.
 * This class iterates over the list of {@link org.dhatim.cdr.SmooksResourceConfiguration} 
 * elements targeted at the {@link org.dhatim.container.ExecutionContext} profile.  It looks for a definition of the named
 * parameter.  If the &lt;param&gt; has a type attribute the 
 * {@link org.dhatim.cdr.ParameterDecoder} for that type can be applied to the attribute
 * value through the {@link #getParameterObject(String,org.dhatim.delivery.ContentDeliveryConfig)} method,
 * returning whatever Java type defined by the {@link org.dhatim.cdr.ParameterDecoder}
 * implementation.  As an example, see {@link org.dhatim.cdr.TokenizedStringParameterDecoder}.
 * 
 * @author tfennelly
 */
public abstract class ParameterAccessor {
     ...
     * <p/>
     * Calls {@link org.dhatim.delivery.ContentDeliveryConfig#getSmooksResourceConfigurations()}
