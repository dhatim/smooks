 ...
 * <p/>
 * Helps supports reflective injection of {@link org.dhatim.delivery.ContentHandler} parameters
 * from its {@link org.dhatim.cdr.SmooksResourceConfiguration} instance.  To inject the whole
 * {@link org.dhatim.cdr.SmooksResourceConfiguration} instance, use the {@link @org.dhatim.cdr.annotation.Config}
 * annotation.
 *
 * <h3>Usage</h3>
 * Where the parameter name is the same as the field name:
 * <pre>
 *     &#64;ConfigParam(decoder={@link org.dhatim.javabean.decoders.IntegerDecoder}.class)
 *     private int maxDigits;
 * </pre>
 * Where the parameter name is NOT the same as the field name:
 * <pre>
 *     &#64;ConfigParam(name="max-digits", decoder={@link org.dhatim.javabean.decoders.IntegerDecoder}.class)
 *     private int maxDigits;
 * </pre>
 *
