...
import org.dhatim.cdr.xpath.evaluators.equality.*;
...
public abstract class XPathExpressionEvaluator {
    ...
    /**
     * Does this XPath expression evaluate for the supplied {@link org.dhatim.delivery.sax.SAXElement} context object.
     * <p/>
     * The implementation can update the context to a parent element if the expression targets
     * multiple contexts.
     *
     * @param element          The {@link org.dhatim.delivery.sax.SAXElement} context to be evaluated against.
     * @param executionContext Smooks {@link org.dhatim.container.ExecutionContext}.
