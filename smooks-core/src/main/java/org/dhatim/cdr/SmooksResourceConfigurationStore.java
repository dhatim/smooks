...
import org.dhatim.delivery.JavaContentHandlerFactory;
import org.dhatim.delivery.UnsupportedContentHandlerTypeException;
...
/**
 * {@link org.dhatim.cdr.SmooksResourceConfiguration} context store.
 * <p/>
 * Stores the {@link org.dhatim.cdr.SmooksResourceConfiguration SmooksResourceConfigurations}
 * for a given container context in the form of 
 * {@link org.dhatim.cdr.SmooksResourceConfigurationList} entries.  Also maintains
...
public class SmooksResourceConfigurationStore {
    ...
    /**
     * Get the {@link org.dhatim.delivery.ContentHandlerFactory} for a resource based on the
     * supplied resource type.
     * <p/>
     * Note that {@link org.dhatim.delivery.ContentHandlerFactory} implementations must be  configured under a selector value of "cdu-creator".
     * @param type {@link org.dhatim.delivery.ContentHandlerFactory} type e.g. "class", "xsl" etc.
     * @return {@link org.dhatim.delivery.ContentHandlerFactory} for the resource.
     * @throws org.dhatim.delivery.UnsupportedContentHandlerTypeException No {@link org.dhatim.delivery.ContentHandlerFactory}
    ...
    /**
     * Close this resource configuration store, {@link org.dhatim.delivery.annotation.Uninitialize uninitializing}
     * all {@link org.dhatim.delivery.ContentHandler ContentHandlers} allocated from this store instance.
     */
    public void close() {
