...
import org.dhatim.dtd.DTDStore;
...
public abstract class AbstractContentDeliveryConfig implements ContentDeliveryConfig {
    ...
    /**
     * Get the list of {@link org.dhatim.cdr.SmooksResourceConfiguration}s for the specified selector definition.
    ...
    /**
     * Get the {@link org.dhatim.cdr.SmooksResourceConfiguration} map for the target execution context.
     * <p/>
     * This Map will be {@link org.dhatim.cdr.SmooksResourceConfigurationSortComparator preordered}
     * for the target execution context.
     *
     * @return {@link org.dhatim.cdr.SmooksResourceConfiguration} map for the target execution context, keyed by the configuration
     * {@link org.dhatim.cdr.SmooksResourceConfiguration#getSelector() selector}, with each value being a
     * {@link List} of preordered {@link org.dhatim.cdr.SmooksResourceConfiguration} instances.
     */
    ...
    /**
     * Get a list {@link Object}s from the supplied {@link org.dhatim.cdr.SmooksResourceConfiguration} selector value.
     * <p/>
     * Uses {@link org.dhatim.cdr.SmooksResourceConfigurationStore#getObject(org.dhatim.cdr.SmooksResourceConfiguration)} to construct the object.
    ...
    /* (non-Javadoc)
     * @see org.dhatim.delivery.ContentDeliveryConfig#getDTD()
     */
