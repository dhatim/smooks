 ...
 * <p/>
 * A producer is a {@link org.dhatim.delivery.Visitor} that "produces" a named object that is added to the
 * {@link ExecutionContext} for use by a {@link Consumer} of some sort.  Note that a {@link org.dhatim.delivery.Visitor}
 ...
 * {@link org.dhatim.delivery.Visitor} instances, targetted at the same element selector, based on what the {@link org.dhatim.delivery.Visitor}
