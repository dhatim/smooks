 ...
 * <p/>
 * If the configured parser implements the {@link org.dhatim.xml.SmooksXMLReader}, the configuration will be
 * passed to the parser via {@link org.dhatim.cdr.annotation.ConfigParam} annotaions on config properties
 * defined on the implementation.
 *
 * <h3 id="parserconfig">.cdrl Configuration</h3>
 * <pre>
 * &lt;smooks-resource selector="org.xml.sax.driver" path="org.dhatim.protocolx.XParser" &gt;
 * 	&lt;!--
 * 		Optional list of driver parameters for {@link org.dhatim.xml.SmooksXMLReader} implementations.
 * 		See {@link org.dhatim.cdr.SmooksResourceConfiguration} for how to add configuration parameters.
 * 	--&gt;
 * &lt;/smooks-resource&gt;
 * </pre>
 *
