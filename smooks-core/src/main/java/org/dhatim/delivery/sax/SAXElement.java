 ...
 * <p/>
 * {@link org.dhatim.delivery.sax.SAXVisitor} implementations will be passed
 * an instance of this class for each of the event methods of
 * {@link org.dhatim.delivery.sax.SAXVisitor} implementations.
 * 
 * <h3 id="element-writing">Element Writing/Serialization</h3>
 * Each SAXElement instance has a {@link Writer writer} set on it.
 * {@link org.dhatim.delivery.sax.SAXVisitor} implementations can take care of
 * serializing the elements at which they are targeted themselves.  Alternatively, they
 * can use the {@link org.dhatim.delivery.sax.SAXElementWriterUtil} class.
 * <p/>
 * {@link org.dhatim.delivery.sax.SAXVisitor} implementations can also control the serialization
