 ...
 * <p/>
 * Additional configurations can be carried out on the {@link org.dhatim.Smooks} instance
 * through the {@link org.dhatim.SmooksUtil} class.
 * <p/>
 * The basic usage scenario for this class might be as follows:
 * <ol>
 * <li>Develop (or reuse) an implementation of {@link org.dhatim.delivery.dom.DOMElementVisitor}/{@link org.dhatim.delivery.sax.SAXElementVisitor} to
 ...
 * <li>Write a {@link org.dhatim.cdr.SmooksResourceConfiguration resource configuration} to target the {@link org.dhatim.delivery.dom.DOMElementVisitor}/{@link org.dhatim.delivery.sax.SAXElementVisitor}
 ...
 * </li>
 * </ol>
 * Remember, you can implement and apply multiple {@link org.dhatim.delivery.dom.DOMElementVisitor DOMElementVisitors}/{@link org.dhatim.delivery.sax.SAXElementVisitor}
 * within the context of a single filtering operation.  You can also target
 * {@link org.dhatim.delivery.dom.DOMElementVisitor DOMElementVisitors}/{@link org.dhatim.delivery.sax.SAXElementVisitor} based on target profiles, and so use a single
...
public class Smooks {
     ...
     * which resolves the resourceURI parameter using a {@link org.dhatim.resource.URIResourceLocator}.
     * <p/>
     ...
     * <p/>
     * Uses the {@link org.dhatim.resource.URIResourceLocator} class to load the resource.
     * <p/>
     * These configurations do not overwrite previously added configurations.
     * They are added to the list of configurations on this Smooks instance.
     *
     * @param resourceURI The URI string for the resource configuration list. See
     *                    {@link org.dhatim.resource.URIResourceLocator}.
     * @throws IOException  Error reading resource stream.
     * @throws SAXException Error parsing the resource stream.
     */
     ...
     * which is the default base URI on all {@link org.dhatim.resource.URIResourceLocator}
     * instances.
     *
     * @param resourceConfigStream The resource configuration stream.
     * @throws IOException  Error reading resource stream.
     ...
     * {@link #filterSource(org.dhatim.container.ExecutionContext, javax.xml.transform.Source, javax.xml.transform.Result...)} 
     ...
     * {@link org.dhatim.container.BoundAttributeStore bound} to the execution context (before and after the calls), providing the
     * caller with a mechanism for interacting with the content {@link org.dhatim.delivery.dom.SmooksDOMFilter filtering} phases.
     *
    ...
    /**
     * Get the Smooks {@link org.dhatim.container.ApplicationContext} associated with
     * this Smooks instance.
     *
     * @return The Smooks {@link org.dhatim.container.ApplicationContext}.
     */
     ...
     * <p/>
     * Should result in the {@link org.dhatim.delivery.annotation.Uninitialize uninitialization}
     * of all allocated {@link org.dhatim.delivery.ContentHandler} instances.
     */
    public void close() {
