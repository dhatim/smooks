...
public interface ExecutionContext extends BoundAttributeStore {
     ...
     */
    public static final URI DOCUMENT_URI = URI.create("org.dhatim:smooks:unknowndoc");
     ...
     *
     * @return The target {@link org.dhatim.profile.ProfileSet}.
     */
     ...
     * @see org.dhatim.event.BasicExecutionEventListener
     */
     ...
     * <p/>
     * For more fine grained control, see the {@link org.dhatim.cdr.ParameterAccessor} class.
     ...
     * <p/>
     * This is controlled by the {@link org.dhatim.delivery.Filter#DEFAULT_SERIALIZATION_ON}
