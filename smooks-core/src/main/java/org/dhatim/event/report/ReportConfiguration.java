...
public class ReportConfiguration {
    ...
    /**
     * Set a list of {@link org.dhatim.event.ExecutionEvent event} types on which to filter.
     * <p/>
     * The listener will only capture {@link org.dhatim.event.ExecutionEvent event} types
