 ...
 * </pre>
 * If this information was available we could target {@link org.dhatim.delivery.ContentHandler}s
 * at elements containing "URI" attributes.  
 * <p/>
 * Another examples of this idea of using DTD ENTITY definitions to target
 * {@link org.dhatim.delivery.ContentHandler}s at specific elements (rather than using the element names)
