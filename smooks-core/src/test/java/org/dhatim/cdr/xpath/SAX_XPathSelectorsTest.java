...
public class SAX_XPathSelectorsTest {
    ...
    public void test_02() throws IOException, SAXException {
        ...
        try {
            ...
            assertEquals("Unsupported selector 'item[@code = '8655']/units[text() = 1]' on resource 'Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [item[@code = '8655']/units[text() = 1]], Selector Namespace URI: [null], Resource: [org.dhatim.cdr.xpath.XPathVisitor], Num Params: [0]'.  The 'text()' XPath token is only supported on SAX Visitor implementations that implement the org.dhatim.delivery.sax.SAXVisitAfter interface only.  Class 'org.dhatim.cdr.xpath.XPathVisitor' implements other SAX Visitor interfaces.", e.getMessage());
        }
    }
