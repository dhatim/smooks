...
import org.dhatim.cdr.annotation.*;
...
import org.dhatim.container.MockApplicationContext;
...
public class ConfiguratorTest {
    ...
    public void test_paramaterSetting_Config_setConfiguration_on_private_inner_class() {
        ...
        try {
            ...
            assertEquals("Error invoking 'setConfiguration' method on class 'org.dhatim.cdr.ConfiguratorTest$MyContentDeliveryUnit4'.  This class must be public.  Alternatively, use the @Config annotation on a class field.", e.getMessage());
        }
    }
    ...
    public void test_paramaterSetting_decode_error() {
        ...
        try {
            ...
            assertEquals("Failed to set paramater configuration value on 'org.dhatim.cdr.ConfiguratorTest$MyContentDeliveryUnit7#encoding'.", e.getMessage());
    ...
    public void test_paramaterSetting_setterMethod() {
        ...
        try {
            ...
            assertEquals("Unable to determine the property name associated with 'org.dhatim.cdr.ConfiguratorTest$MyContentDeliveryUnit9#encoding'. " +
    ...
    public void test_Initialize_Uninitialize() {
        ...
        try {
            ...
            assertEquals("Error invoking @Initialize method 'init' on class 'org.dhatim.cdr.ConfiguratorTest$MyContentDeliveryUnit12'.", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("Error invoking @Uninitialize method 'uninit' on class 'org.dhatim.cdr.ConfiguratorTest$MyContentDeliveryUnit12'.", e.getMessage());
        }
    }
