...
public class ElementWritingTest {
    ...
    public void test_one_writer_per_element() throws IOException, SAXException {
        ...
        try {
            ...
            assertEquals("Illegal access to the element writer for element 'a' by SAX visitor 'org.dhatim.delivery.sax.SAXVisitorWriter02'.  Writer already acquired by SAX visitor 'org.dhatim.delivery.sax.SAXVisitorWriter01'.  See SAXElement javadocs (http://milyn.codehaus.org/Smooks).  Change Smooks visitor resource configuration.", e.getCause().getMessage());
        }
    }
