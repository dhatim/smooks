...
package org.dhatim.delivery.dom.serialize;
...
public class EmptyElTestSerializationUnit extends DefaultSerializationUnit {
	...
	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementStart(org.w3c.dom.Element, java.io.Writer, org.dhatim.device.UAContext)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementEnd(org.w3c.dom.Element, java.io.Writer, org.dhatim.device.UAContext)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementText(org.w3c.dom.Text, java.io.Writer, org.dhatim.device.UAContext)
	 */
	public void writeElementText(Text text, Writer writer, ExecutionContext executionContext) throws IOException {
	}

	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementComment(org.w3c.dom.Comment, java.io.Writer, org.dhatim.device.UAContext)
	 */
	public void writeElementComment(Comment comment, Writer writer, ExecutionContext executionContext) throws IOException {
	}

	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementEntityRef(org.w3c.dom.EntityReference, java.io.Writer, org.dhatim.device.UAContext)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementCDATA(org.w3c.dom.CDATASection, java.io.Writer, org.dhatim.device.UAContext)
	 */
	public void writeElementCDATA(CDATASection cdata, Writer writer, ExecutionContext executionContext) throws IOException {
	}

	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeElementNode(org.w3c.dom.Node, java.io.Writer, org.dhatim.device.UAContext)
	 */
	public void writeElementNode(Node node, Writer writer, ExecutionContext executionContext) throws IOException {
	}
	
	/* (non-Javadoc)
	 * @see org.dhatim.serialize.SerializationUnit#writeChildElements()
	 */
