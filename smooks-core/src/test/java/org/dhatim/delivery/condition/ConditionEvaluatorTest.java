...
*/
package org.dhatim.delivery.condition;
...
import org.dhatim.delivery.SAXAndDOMVisitor;
...
public class ConditionEvaluatorTest {
    ...
    public void test_Factory() {
        try {
            ...
            assertEquals("Unsupported ExpressionEvaluator type 'org.dhatim.delivery.condition.InvalidEvaluator'.  Currently only support 'org.dhatim.expression.ExecutionContextExpressionEvaluator' implementations.", e.getMessage());
        }
