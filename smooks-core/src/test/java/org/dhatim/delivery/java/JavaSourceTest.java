...
public class JavaSourceTest {
    ...
    private static String EXPECTED_1 = "<org.dhatim.delivery.java.MyBean1><prop1>true</prop1><prop2>hello</prop2><prop3>1111</prop3><mybean2><prop5>true</prop5><prop6>hello</prop6></mybean2></org.dhatim.delivery.java.MyBean1>";

    private static List<Object> SOURCE_2 = Arrays.asList(new Object[] {new MyBean2(), new MyBean2()});
    private static String EXPECTED_2 = "<org.dhatim.delivery.java.MyBean2><prop5>true</prop5><prop6>hello</prop6></org.dhatim.delivery.java.MyBean2><org.dhatim.delivery.java.MyBean2><prop5>true</prop5><prop6>hello</prop6></org.dhatim.delivery.java.MyBean2>";
}
