...
import org.dhatim.delivery.ordering.testvisitors.TestProducer;
import org.dhatim.delivery.ordering.testvisitors.TestVisitor;
import org.dhatim.delivery.ordering.testvisitors.TestConsumer;
import org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer;
    ...
    public void test_sort_2way_dependency_01() {
        ...
        try {
            ...
            assertEquals(("Invalid 2-Way/Circular Visitor Producer/Consumer dependency detected in configuration.\n" +
                    "\tTarget Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [0], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]\n" +
                    "\t\tdepends-on: Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [1], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]\n" +
                    "\t\t\tdepends-on: Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [0], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]").trim(), e.getMessage().trim());
        }
    }
    ...
    public void test_sort_2way_dependency_02() {
        ...
        try {
            ...
            assertEquals(("Invalid 2-Way/Circular Visitor Producer/Consumer dependency detected in configuration.\n" +
                    "\tTarget Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [0], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]\n" +
                    "\t\tdepends-on: Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [1], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]\n" +
                    "\t\t\tdepends-on: Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [2], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]\n" +
                    "\t\t\t\tdepends-on: Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [3], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]\n" +
                    "\t\t\t\t\tdepends-on: Target Profile: [[org.dhatim.profile.Profile#default_profile]], Selector: [0], Selector Namespace URI: [null], Resource: [org.dhatim.delivery.ordering.testvisitors.TestProducerConsumer], Num Params: [0]").trim(), e.getMessage().trim());
        }
    }
