...
public class SmooksTest {
    ...
    public void test_setResourceLocator() throws IOException, SAXException {
        Smooks smooks = new Smooks("classpath:/org/dhatim/test_setClassLoader_01.xml");
		...
		assertEquals("classpath:/org/dhatim/", resourceLocator.getBaseURI().toString());
		assertEquals("classpath:/org/dhatim/somethingelse.xml", resourceLocator.getBaseURI().resolve("somethingelse.xml").toString());
    }
