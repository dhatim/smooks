...
public class ArchiveTest {
    ...
    public void test_produced_zip() throws IOException {
        ...
        assertEquals("org/dhatim/archive/Archive.class", archive.getEntryName(2));
        ...
        // Archive.class
        zipEntry = zipInputStream.getNextEntry();
        assertEquals("org/dhatim/archive/Archive.class", zipEntry.getName());
    }
    ...
    public void test_toFileSystem() throws IOException {
        ...
        assertTrue(new File(folder, "my/emptyfile.xxx").exists());
            assertTrue(new File(folder, "org/dhatim/archive/Archive.class").exists());
    }
