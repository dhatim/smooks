...
public class ScannerTest {
    ...
    public void test_instanceof_has_include() throws IOException {
        ...
        InstanceOfFilter filter = new InstanceOfFilter(Filter.class, null, new String[] {"org/dhatim"});
    ...
    public void test_annotated_has_include() throws IOException {
        IsAnnotationPresentFilter filter = new IsAnnotationPresentFilter(TestAnnotation.class, null, new String[] {"org/dhatim"});
        Scanner scanner = new Scanner(filter);
