...
*/
package org.dhatim.scribe.annotation;
 ...
 * for the entity that is going to be deleted.
 * <p>
...
public @interface Delete {
	...
	/**
	 * The name of the delete operation. If it is not set then
