 ...
 *
 * Default implementation loading EDIFACT models based on the specified list of
 * model files which could be provided either via constructor or via
 * {@link #addModelReferences(String, URI)} method.
 *
 * @author zubairov
 */
public class DefaultMappingsRegistry extends AbstractMappingsRegistry {
     ...
     * {@link #modelReferences} map and returns them all back. It is actually
     * ignoring nameComponents parameter because no on-demand loading is
     * happening here.
     *
