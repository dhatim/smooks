...
import org.dhatim.edisax.model.internal.Import;
import org.dhatim.edisax.model.internal.MappingNode;
import org.dhatim.edisax.model.internal.ParamEntry;
...
import org.dhatim.javabean.decoders.CustomDecoder;
...
/**
 * Digests an edi-message-mapping and populates a {@link org.dhatim.edisax.model.internal.Edimap}.
 *
 * @author bardl
 */
public class EDIConfigDigester {
     ...
     * @return the {@link org.dhatim.edisax.model.internal.Edimap}.
     ...
     * @param edimap the {@link org.dhatim.edisax.model.internal.Edimap} to populate.
     * @param schemaName the schema uri.
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when unable to retrieve namespace in configuration.
     */
     ...
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
     ...
     * @param segmentGroup the {@link org.dhatim.edisax.model.internal.SegmentGroup} to populate.
     * @param namespacePrefix the prefix used to name elements in xml.
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
     ...
     * @param field the {@link org.dhatim.edisax.model.internal.Field} to populate
     * @param namespacePrefix the prefix used to name elements in xml.
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
     ...
     * @param component the {@link org.dhatim.edisax.model.internal.Component} to populate.
     * @param namespacePrefix the prefix used to name elements in xml.
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
    ...
    /**
     * Set values in {@link org.dhatim.edisax.model.internal.Segment}.
     * @param segment the {@link org.dhatim.edisax.model.internal.Segment} to populate.
     * @param node the Segment element.
     */
    ...
    /**
     * Set values in {@link org.dhatim.edisax.model.internal.Field}.
     * @param field the {@link org.dhatim.edisax.model.internal.Field} to populate.
     * @param node the Field element.
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
    ...
    /**
     * Set values in {@link org.dhatim.edisax.model.internal.Component}.
     * @param component the {@link org.dhatim.edisax.model.internal.Component} to populate.
     * @param node the Component element.
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when values are badly formatted.
     */
    ...
    /**
     * Set values in {@link org.dhatim.edisax.model.internal.SubComponent}.
     * @param node the {@link org.dhatim.edisax.model.internal.SubComponent} to populate.
    ...
    /**
     * Set values in {@link org.dhatim.edisax.model.internal.MappingNode}.
     * @param node the {@link org.dhatim.edisax.model.internal.MappingNode} to populate.
    ...
    /**
     * Set values in {@link org.dhatim.edisax.model.internal.ValueNode}.
     * @param node the {@link org.dhatim.edisax.model.internal.ValueNode} to populate.
...
//                }
     ...
     * @throws org.dhatim.edisax.EDIConfigurationException is thrown when no namespace exists in configuration.
     */
