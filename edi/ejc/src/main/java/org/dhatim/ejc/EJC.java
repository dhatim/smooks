...
import static org.dhatim.ejc.EJCLogFactory.Level;
 ...
 * <ol>
 * <li>{@link ClassModelCompiler} - parse a edi-mapping-file a creates a {@link org.dhatim.ejc.ClassModel}.</li>
 * <li>{@link org.dhatim.ejc.BeanWriter} - generates javaimplementation from {@link org.dhatim.ejc.ClassModel}.</li>
 * <li>{@link org.dhatim.ejc.BindingWriter} - generates a bindingfile from {@link org.dhatim.ejc.ClassModel}.</li>
 * </ol>
 *
...
public class EJC {
    ...
    /**
     * Add the {@link org.dhatim.smooks.edi.EDIMessage} annotation to the
     ...
     * 1. {@link ClassModelCompiler} - parse a edi-mapping-file a creates a {@link org.dhatim.ejc.ClassModel}.
     * 2. {@link org.dhatim.ejc.BeanWriter} - generates javaimplementation from {@link org.dhatim.ejc.ClassModel}.
     * 3. {@link org.dhatim.ejc.BindingWriter} - generates a bindingfile from {@link org.dhatim.ejc.ClassModel}.
     ...
     * @throws org.dhatim.edisax.EDIConfigurationException when error occurs while reading ediConfiguration.
