...
import org.dhatim.smooks.edi.unedifact.model.UNEdifactInterchange;
import org.dhatim.smooks.edi.unedifact.model.UNEdifactInterchangeFactory;
import org.dhatim.smooks.edi.unedifact.model.r41.UNB41;
import org.dhatim.smooks.edi.unedifact.model.r41.UNEdifactInterchange41;
import org.dhatim.smooks.edi.unedifact.model.r41.UNEdifactMessage41;
import org.dhatim.smooks.edi.unedifact.model.r41.types.MessageIdentifier;
...
public class InterchangeTestUtil {
    ...
    private static MessageBuilder defaultUNAMessageBuilder = new MessageBuilder("org.dhatim", UNEdifactInterchangeParser.defaultUNEdifactDelimiters.getField(), UNEdifactInterchangeParser.defaultUNEdifactDelimiters);
    private static MessageBuilder commaDecimalSepUNAMessageBuilder = new MessageBuilder("org.dhatim", UNEdifactInterchangeParser.defaultUNEdifactDelimiters.getField(), UNEdifactInterchangeParser.defaultUNEdifactDelimiters);

    static {
        Delimiters delimiters = ((Delimiters) UNEdifactInterchangeParser.defaultUNEdifactDelimiters.clone()).setDecimalSeparator(",");
        commaDecimalSepUNAMessageBuilder = new MessageBuilder("org.dhatim", delimiters.getField(), delimiters);
    }
