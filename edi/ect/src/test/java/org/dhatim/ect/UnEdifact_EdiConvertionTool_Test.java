...
public class UnEdifact_EdiConvertionTool_Test {
    ...
    public void test_D08A_longName() throws IOException {
        ...
        EdiConvertionTool.fromUnEdifactSpec(zipInputStream, new ZipOutputStream(new FileOutputStream(modelSetFile)), "org.dhatim.edi.unedifact:d08a:1.0-SNAPSHOT", false);
    }
