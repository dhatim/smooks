...
public class UnEdifactSpecificationReader implements EdiSpecificationReader {
	...
	public Properties getInterchangeProperties() {
        ...
        properties.setProperty(EdiSpecificationReader.MESSAGE_BINDING_CONFIG, "/org/dhatim/smooks/edi/unedifact/model/r41/bindings/unedifact-message.xml");
        properties.setProperty(EdiSpecificationReader.INTERCHANGE_BINDING_CONFIG, "/org/dhatim/smooks/edi/unedifact/model/r41/bindings/unedifact-interchange.xml");
